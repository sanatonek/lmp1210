...
|           | Handout                | Due
|-----------|------------------------|---------
| **Math Diagnostics**   |  [Handout](files/pdfs/math_diagnostic.pdf)  | January 18 2024
| **Assignment #1**   |  [Handout](files/assignments/hw1.pdf), [Data](files/assignments/hw1_data.csv) | February 1 2024
| **Assignment #2**   |  [Handout](files/assignments/hw2.pdf), [Data](files/assignments/hw2_data.csv)  | February 15 2024
| **Assignment #3**   | [Handout](files/assignments/hw3.pdf), [Data](files/assignments/A3_data.zip) | March 7 2024
| **Final Project**   | [Handout](files/pdfs/project_handout.pdf)  | February 22 2024 (Proposal)<br> April 8 2024 (Final report)
...
|-------|----|------------------------|---------|------------------------------------------|-----------------
| **Lecture&nbsp;1** | Jan 11 | Intro to ML in medicine, nearest neighbor classifier | [Slides](files/slides/L1-intro_nearest_neighbor.pdf) | B: 1-2 (emphasis on 2.5.2); DL: 2-5   |
| **Lecture&nbsp;2** | Jan 18 | Tree-based classifier; Python tutorial for introduction to Python| [Slides](files/slides/L2-Decision_tree.pdf) [Colab](https://colab.research.google.com/drive/1EVB5h4rXhVvICI2UqUkY8bevnJwil9Ro?usp=sharing) | DL: 2, [David Liu's CSC110/111 Course Notes](https://www.teach.cs.toronto.edu/~csc110y/fall/notes/), [Training a Classifier](https://csc413-uoft.github.io/2021/assets/readings/L01c.pdf), MK: p. 22-36 | Math diagnostic Due
| **Lecture&nbsp;3** | Jan 25 | Linear methods for regression and classification; Python tutorial for evaluation methods |  [Slides](files/slides/L3-Linear_models.pdf) [Colab](https://colab.research.google.com/drive/13T2ynyJdmZcOR68Ozt4T4ATJOYTmm1Fc?usp=sharing)|  B: 3-4; RG: [Linear Regression](https://csc413-uoft.github.io/2021/assets/readings/L01a.pdf), [Linear Classifiers](https://csc413-uoft.github.io/2021/assets/readings/L01b.pdf)|
...
| **Lecture&nbsp;5** | Feb 08  | Ensemble models; Python tutorial for supervised learning practice  |  [Slides](files/slides/L5-Ensembles.pdf) [Colab](https://colab.research.google.com/drive/1UARJRLQ0L8KfpoZDu8W_zikn1ygq3nPm?usp=sharing)  |  |
| **Lecture&nbsp;6** | Feb 15  | Unsupervised learning for clustering: K-means, Gaussian mixture models | [Slides](files/slides/L7.pdf)  | B: 9; RG: [Mixture Models](https://www.cs.toronto.edu/~rgrosse/courses/csc311_f21/readings/Mixture%20Modeling.pdf)  | Assignment #2 Due
...
| **Lecture&nbsp;9** | Mar 14  | Guest Lecturer: Dr. Robert Grant <br> Machine Learning in Oncology|  |   |
| **Lecture&nbsp;10** | Mar 21  | Advanced deep learning methods for medical image analysis | [Slides](files/slides/Lecture10.pdf) |  | 
