...
| **Lecture&nbsp;2** | Jan 18 | Tree-based classifier; Introduction to Python| [Slides](files/slides/L2-Decision_tree.pdf) [Colab](https://colab.research.google.com/drive/1EVB5h4rXhVvICI2UqUkY8bevnJwil9Ro?usp=sharing#scrollTo=pdLPFTyR4oJQ) | DL: 2, [David Liu's CSC110/111 Course Notes](https://www.teach.cs.toronto.edu/~csc110y/fall/notes/), [Training a Classifier](https://csc413-uoft.github.io/2021/assets/readings/L01c.pdf), MK: p. 22-36 | Math diagnostic Due
| **Lecture&nbsp;3** | Jan 25 | Linear methods for regression and classification; evaluation methods |  Slides |  B: 3-4; RG: [Linear Regression](https://csc413-uoft.github.io/2021/assets/readings/L01a.pdf), [Linear Classifiers](https://csc413-uoft.github.io/2021/assets/readings/L01b.pdf)|
