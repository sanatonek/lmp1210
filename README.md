...
| **Assignment #2**   |    | TBA
| **Assignment #3**   |    | TBA
| **Final Project**   |  [Handout](assets/project_handout.pdf)  | -
...
| **Lecture&nbsp;3** | Jan 26 | Introduction to Python; basic linear algebra; evaluation methods |  Colab | DL: 2, [David Liu's CSC110/111 Course Notes](https://www.teach.cs.toronto.edu/~csc110y/fall/notes/)  |
| **Lecture&nbsp;4** | Feb 02  | ENSEMBLE-based methods; neural networks  |  Slides  |  DL: 6-8; RG: [Multilayer Perceptrons](https://csc413-uoft.github.io/2021/assets/readings/L02a.pdf), [Backpropagation (quite technical)](https://csc413-uoft.github.io/2021/assets/readings/L02b.pdf)  | Assignment #1 Due
